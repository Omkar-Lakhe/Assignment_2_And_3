...
#To find the x and y co-ordinates of the image
...
im1.save('Data\main4-1.jpg')
Image.open('Data\main4-1.jpg')
...
img = cv2.imread('Data\main4-1.jpg')
...
cv2.imwrite("Data\main4-2.jpg",img)
